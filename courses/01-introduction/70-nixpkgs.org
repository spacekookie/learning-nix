...
\\
   ...
   #+BEGIN_SRC nix
     ...
     pkgs.emacsWithPackages (epkgs:
       let
         ...
         modules = [
           ./base ./move-lines ./multi-cursor
           ./kookie-notmuch ./notmuch-rules
           ./org ./rust ./theme
         ];
   ...
   https://cyberchaos.dev/kookie/nomicon/-/blob/main/infra/libkookie/overlays/kookie/emacs/default.nix
